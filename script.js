...
// Função para desenhar todos os efeitos
...
function connectToRealms() {
    // Redireciona diretamente para o Minecraft Realms
    window.location.href = 'minecraft://realms/play/1234567890abcdef';
}

function copyCode() {
    // Cria um elemento temporário para copiar o código
    const tempInput = document.createElement('textarea');
    tempInput.value = 'minecraft://realms/play/1234567890abcdef';
